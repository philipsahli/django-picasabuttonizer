...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('picasabuttonizer_openbutton', 'open', 'spec')
        db.rename_column('picasabuttonizer_trayexecbutton', 'exe_name', 'spec')


    def backwards(self, orm):
        db.rename_column('picasabuttonizer_openbutton', 'spec', 'open')
        db.rename_column('picasabuttonizer_trayexecbutton', 'spec', 'exe_name')
